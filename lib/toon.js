 ...
 */
export function encode(value, options = {}, level = 0) {
    const { indent = 2, keyFolding = true, maxArrayPreview = 100, compactPrimitives = true } = options;
    ...
    if (Array.isArray(value)) {
        ...
        if (typeof first === 'object' && first !== null && !Array.isArray(first)) {
            ...
            const isUniform = previewValue.every(item => typeof item === 'object' &&
                item !== null &&
                !Array.isArray(item) &&
        ...
        const isPrimitive = previewValue.every(v => v === null ||
            typeof v === 'string' ||
            typeof v === 'number' ||
            typeof v === 'boolean');
 ...
 * tags[N]: <tag1>
 */
export function generateStructure(schema, options = {}, level = 0) {
 ...
 */
export function isValidToon(input) {
    if (!input || typeof input !== 'string')
        return false;
    try {
